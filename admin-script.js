/* ════════════════════════════════════════════════════════════════════════
   ADMIN DASHBOARD JAVASCRIPT — Gokurakugai Community
   Loaded as <script src="admin-script.js"> at the bottom of index.html.
   Firebase is already initialized in the page <head> — this file reuses
   that existing instance rather than re-initializing.
════════════════════════════════════════════════════════════════════════ */

/* ── Reuse the Firebase instance already initialized in the page head ──
   window.db and window.storage are set by the head inline script.
   We also keep a fallback to firebase.firestore() / firebase.storage()
   in case admin-script.js ever runs standalone.
─────────────────────────────────────────────────────────────────────── */
const fdb      = window.db      || (firebase && firebase.firestore && firebase.firestore());
const fstorage = window.storage || (firebase && firebase.storage  && firebase.storage());
...
// Trigger admin verify if already on admin tab (e.g. deep-link or page reload)
